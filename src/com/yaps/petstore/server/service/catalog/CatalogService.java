...
public final class CatalogService extends AbstractRemoteService implements CatalogServiceRemote {
	...
	/* (non-Javadoc)
	 * @see com.yaps.petstore.server.service.catalog.CatalogServiceRemote#findProducts(java.lang.String)
	 */
	public Collection findProducts(final String categoryId) throws FinderException, RemoteException {
		final String mname = "findProducts";
        Trace.entering(getCname(), mname);
	...
	/* (non-Javadoc)
	 * @see com.yaps.petstore.server.service.catalog.CatalogServiceRemote#findItems(java.lang.String)
	 */
